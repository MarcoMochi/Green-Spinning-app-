...
public class NewsFragment extends Fragment {
    ...
    private void prepareNews() {
        ...
        a = new News("A.I for Energy Efficiency", "The US Energy Information Agency (EIA) defines renewable energy as an energy source that naturally regenerate, such ...","The U.S. Energy Information Agency (EIA) defines renewable energy as an energy source that naturally regenerates, such as solar or wind. In contrast, fossil fuels are considered finite. The EIA reports that in 2016, 10 percent of all energy consumed in the U.S. was derived from renewable energy sources. This is equivalent to roughly “10.2 quadrillion British thermal units (Btu) —1 quadrillion is the number 1 followed by 15 zeros”.\n" +
                "\n" +
        ...
        a = new News("Renewable Energy from Wood Wastes", "Food waste is an untapped energy source which mostly ends up rotting in landfills thereby greenhouse gases ...","Food waste is an untapped energy source which mostly ends up rotting in landfills thereby releasing greenhouse gases into the atmosphere. Food waste is difficult to treat or recycle since it contains high levels of sodium salt and moisture, and is mixed with other waste during collection. Major generators of food wastes include hotels, restaurants, supermarkets, residential blocks, cafeterias, airline caterers, food processing industries etc.\n" +
                "\n" +
